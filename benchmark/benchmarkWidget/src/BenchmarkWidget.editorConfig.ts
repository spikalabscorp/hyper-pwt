...
// export function getPreview(values: BenchmarkWidgetPreviewProps, isDarkMode: boolean, version: number[]): PreviewProps {
...
// export function getCustomCaption(values: BenchmarkWidgetPreviewProps, platform: Platform): string {
